...
/** A generic cache with a time-to-live (TTL) mechanism. This cache stores key-value pairs along with their insertion timestamp.
  * Items can be added, retrieved, and checked for existence. Expired items are automatically removed by a background expiration
  * daemon.
  *
  * @param ttl
...
/** Companion object for the Cache class. Provides a factory method to create a cache instance with a specified time-to-live (TTL)
  * duration.
  */
object Cache:
